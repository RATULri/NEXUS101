...
public class CourseDownloadByStudent {

    CourseInfoDownloadCallBack mCallback;
    CourseApiInterface apiService;

    public CourseDownloadByStudent(CourseInfoDownloadCallBack courseInfoDownloadCallBack){
    ...
    public void run(int id) {
        ...
        Call<CourseResponse> call = apiService.getCoursesByStudent(id);
