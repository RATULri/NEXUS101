...
public class GroupDownloadByStudent {

    GroupInfoDownloadCallBack mCallback;
    GroupApiInterface apiService;

    public GroupDownloadByStudent(GroupInfoDownloadCallBack groupInfoDownloadCallBack){
    ...
    public void run(int id) {
        ...
        Call<GroupResponse> call = apiService.getGroupByStudent(id);
